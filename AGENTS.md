...
- **Plugin Core**: `Source/PluginProcessor.h` & `Source/PluginProcessor.cpp` manage audio processing, APVTS parameters, a single unified libspecbleach stereo group (`engineGroup`), `juce::dsp::DryWetMixer`, and FFT visualization fifo.
