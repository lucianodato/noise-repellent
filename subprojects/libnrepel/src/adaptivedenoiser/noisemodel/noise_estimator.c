...
adaptive_noise_estimation_initialize(const uint32_t fft_size,
                                     const uint32_t sample_rate,
                                     NoiseProfile *noise_profile) {
  NoiseEstimatorAdaptive *self =
      (NoiseEstimatorAdaptive *)calloc(1U, sizeof(NoiseEstimatorAdaptive));
